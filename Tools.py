clear 
 ...
 ku='\033[33;1m' #KUNING 
 echo 
 echo $i"Selamat Datang Di TOOLS bARU sAYA"
 echo 
 sleep 6 
 clear 
 echo 
 ...
 echo $bi"¦"$bi"  Gmail   : Persekuharyono@gmail.com"$bi"    ¦" 
 echo $i"¦"$bi"  Youtube :  Persekukhaya "$i"             ¦" 
 echo $me"==================="$ku" ===================" 
 echo 
 ...
 echo $cy"?"$pu"10"$cy"?"$bi"-» Profile guard Facebook" 
 ...
 then 
 clear 
 figlet -f slant "MltrCyber ."|lolcat 
 sleep 1 
 ...
 echo $i"Melalui Via:" 
 sleep 2 
 echo $ku"Facebook :"$pur" Haryono Frans Kudir" 
 echo $ku"YouTube  :"$pur" Persekukhaya" 
 echo $ku"WhatsApp :"$pur" 081362319526" 
 sleep 2 
 echo $i"dan jangan lupa "$cy" LIKE SHARE AND SUBSCRIBE" 
 sleep 2 
 echo $i"Video Channel "$cy" MltrCyber" 
 sleep 2 
